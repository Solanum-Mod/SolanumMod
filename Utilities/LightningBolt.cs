...
namespace SolanumMod.Utilities
{
    class LightningBolt : ILightning
    {
        ...
        public class Line
        {
            ...
            public void Draw(SpriteBatch spriteBatch, Color tint)
            {
                ...
                Texture2D HalfCircle = ModContent.GetTexture("SolanumMod/Utilities/HalfCircle");
                Texture2D LightningSegment = ModContent.GetTexture("SolanumMod/Utilities/LightningSegment");
